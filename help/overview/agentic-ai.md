---
title: Inteligencia artificial aplicada a la agencia en aplicaciones CX Enterprise
...
ht-degree: 9%
---
# Acerca de la inteligencia artificial aplicada a la agencia en Adobe CX Enterprise

Adobe [Experience Platform Agent Orchestrator](../agents/agent-orchestrator.md) alimenta las capacidades de IA auténtica en las aplicaciones de CX Enterprise.

Los agentes ayudan a automatizar tareas, ofrecer perspectivas más rápido y optimizar los flujos de trabajo. Como resultado, los equipos pueden trabajar de forma más eficiente y obtener más valor de CX Enterprise.

Los agentes de IA de CX Enterprise están disponibles en:
...
En las aplicaciones existentes, puede usar lenguaje natural para instruir a los agentes de Adobe Experience Platform a través de la interfaz conversacional en [Ayudante de IA](../ai-assistant/ai-assistant-ui.md). El asistente de IA está disponible en las vistas de pantalla completa y carril derecho.
...
Los agentes de IA siguen _sus_ datos y supervisión, y respetan los controles de acceso de nivel de producto. Solo puede realizar trabajos o acceder a datos que esté autorizado a utilizar en la aplicación de CX Enterprise subyacente.
...
|---|----------|----------|----------|
| [Audience Agent](../agents/audience.md) | Habilite a sus equipos para que administren y optimicen audiencias utilizando indicaciones de lenguaje natural para que sean más fáciles, eficientes y rápidas de comercializar. | <ul><li>Real-Time CDP (ediciones B2B, B2C y B2P)</li><li>Adobe Journey Optimizer (ediciones B2B y B2C)</li></ul> | |
...
| [Journey Agent](../agents/ajo-agent.md) | Permita que sus equipos analicen y optimicen rápidamente los recorridos de clientes multitáctiles a escala. | <ul><li>Adobe Journey Optimizer (ediciones B2B y B2C)</li></ul> | |
| [Agente de soporte técnico](../agents/product-support.md) | Solucione los problemas de soporte sin salir de sus flujos de trabajo, cree vales de soporte al cliente y rastree el progreso de los casos con el Asistente de IA. | <ul><li>Real-Time CDP (Ediciones B2B, B2C y B2P)</li><li>Adobe Journey Optimizer (Ediciones B2B y B2C)</li><li>Customer Journey Analytics (Ediciones B2B y B2C)</li><li>Adobe Experience Manager</li></ul> | |
| [Adobe Marketing Agent para Microsoft 365 Copilot](../agents/ama-ms.md) | Conecta Experience Platform directamente a Microsoft 365 Copilot. Puede hacer preguntas en lenguaje natural dentro de las aplicaciones de Microsoft 365, como Teams, Word, Powerpoint y Excel, para recuperar instantáneamente la información de marketing de Experience Platform sin interrumpir el flujo de trabajo. | <ul><li> Adobe Agent Orchestrator compatible con Audience Agent, Journey Agent, Customer Journey Analytics Data Insights y Experience Platform Operational Insights</li></ul> | |

## Aplicaciones de CX Enterprise con prioridad de IA {#ai-first-apps}

Las aplicaciones con prioridad de IA se crean con IA generativa o agéntica como componente principal. Utilizan IA generativa o agéntica para tareas clave, y las funciones agénticas ya están incluidas en la licencia de aplicación con prioridad sobre IA. Como tal, no requieren la licencia de Experience Platform Agent Orchestrator.

En la tabla siguiente se enumeran los agentes de Experience Platform disponibles como aplicaciones de IA-First. Se habilitan mediante la licencia de estas aplicaciones con prioridad de IA:
...
* [Herramientas de CX Enterprise Agentic](https://experienceleague.adobe.com/en/docs/cx-enterprise-agentic-tools/using/overview#adobe-cx-enterprise-agentic-tools)
* [Trabajos del agente y consumo de crédito de IA](ai-credit-consumption.md)
* Inicio de la documentación de [AI](https://experienceleague.adobe.com/en/docs/ai)
* [Descripción general de los agentes en Experience Manager as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/overview)

...
description: Aprenda a utilizar Adobe Coworker Chat para analizar los datos de Customer Journey Analytics, crear canales y encontrar dónde abandonan los clientes en el recorrido.
...
Adobe Coworker Chat puede realizar análisis de datos avanzados que anteriormente solo eran posibles en Analysis Workspace. El chat de compañeros accede a los datos de sus vistas de datos de Customer Journey Analytics, lo que le permite explorar esos datos y obtener respuestas a las preguntas en lenguaje natural.
...
* Utilice el modo de plan. Esto es especialmente útil para tareas complejas, pero también puede arrojar mejores resultados para tareas simples porque permite a los compañeros hacer preguntas de seguimiento antes de actuar. Para obtener más información, consulte [Modo de planificación](/help/coworker/chat/ui-guide.md#plan-mode).
...
* Cuando cree una solicitud, sea lo más específico posible:
  ...
  * Hacer referencia a componentes de vista de datos, como dimensiones, métricas y segmentos, por su nombre exacto.
...
Para obtener más información, consulte [Casos de uso](/help/coworker/chat/use-cases.md).
...
* Administrar aptitudes para guardar una aptitud reutilizable

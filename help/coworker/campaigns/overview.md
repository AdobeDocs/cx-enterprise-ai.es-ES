---
description: Obtenga información sobre Adobe Coworker Campaigns, una aplicación de marketing nativa de IA que convierte un solo mensaje en una campaña lista para revisión.
title: Información general de Adobe Coworker
...
1. (Opcional) Cargue una plantilla de correo electrónico de HTML en **Plantillas de correo electrónico** para que Campañas de compañeros aplique su diseño al generar contenido.
   ...
   ![Pantalla de bienvenida para la versión de prueba de Campañas de Coworker](./assets/overview-1.png){width="800" zoomable="yes"}
...
![Pantalla de inicio](./assets/overview-2.gif)

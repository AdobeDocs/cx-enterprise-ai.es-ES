...
- Instrucciones para completar un tipo específico de tarea
- Los pasos que debe seguir el compañero
- La información y las fuentes de datos que se van a utilizar
- El formato de salida esperado
- Directrices sobre cuándo se debe aplicar el flujo de trabajo

## Por qué los equipos utilizan habilidades

Muchas organizaciones realizan los mismos tipos de tareas repetidamente, entre ellas:

- Informes de rendimiento semanales
- Análisis del recorrido del cliente
- Resúmenes ejecutivos
- Revisiones comerciales estandarizadas
- Flujos de trabajo de análisis repetibles
 
...
En su lugar, las habilidades definen cómo se debe realizar el trabajo mientras el acceso a los datos sigue gobernado por aplicaciones de Adobe conectadas, permisos y controles organizativos.

Esta separación permite a los equipos estandarizar los procesos manteniendo al mismo tiempo la seguridad y la gobernanza adecuadas.
